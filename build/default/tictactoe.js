import { LitElement, css, svg } from "./node_modules/lit-element/lit-element.js"; // Variables to make working with X's and O's cleaner
...
class TicTacToe extends LitElement {
  ...
  static get properties() {
    return {
      ...
      // The winner of the game (null for draws)
      winLine: {
        type: Object // The coordinates for the win line to be drawn between
  ...
  constructor() {
    super(); // Reset the game state

    this.reset(); // Set an initial value for the winLine (it is still hidden by styles)
  ...
  handleClick(x, y) {
    // Update cell
    this.board[y][x] = this.currentPlayer; // Check for win or draw
